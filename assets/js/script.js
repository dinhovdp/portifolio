...
async function getAboutGithub(){
  try{
    ...
    const resposta = await fetch('https://api.github.com/users/dinhovdp')
...
async function getProjectsGitHub(){
  try{
    ...
    const resposta = await fetch('https://api.github.com/users/dinhovdp/repos?sort=update&per_page=6')
